...
\end{table}%
	...
	Temos abaixo o resultado produzido pela execução do \textit{testbench}, que também se encontra em anexos.
	
	COLOCAR PRINT DO TESTBENCH 
...
\subsection{Calculadora de Endereço}
	Foi desenvolvido uma calculadora de endereço que tem o papel de realizar o cálculo do endereço relativo para o endereço físico. Portanto, realizando o papel de deslocar o valor do registro de Segmento
