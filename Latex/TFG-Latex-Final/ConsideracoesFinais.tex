...
\chapter{Considerações Finais}
	...
	Além disso o projeto foi desenvolvido de forma modular, o que facilita a manutenção do código e posteriores melhorias. Além disso, possui uma arquitetura de fácil entendimento o que incentiva a continuação do projeto em trabalhos futuros.
