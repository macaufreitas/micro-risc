...
% but it looks awful.
\begin{textblock}{17}(0.3,0)
\Title{{\textsc {\textsc Suporte da Arquitetura Orientada a Serviços\\ na integração de sistemas médicos}}}
\end{textblock}
...
\parbox{0.30\textwidth}{
    \begin{center}
    \LHead{Tiago Romero Garcia}  \\
    \LHead{Ciência da Computação} \\
    \LHead{Universidade Federal de Itajubá} \\
    \LHead{\texttt{tiagorga@gmail.com}} 
    \end{center}
}
\parbox{0.30\textwidth}{
    \begin{center}
    \LHead{Leonardo Alvarenga Garcia} \\
    \LHead{Ciência da Computação} \\
    \LHead{Universidade Federal de Itajubá} \\
    \LHead{\texttt{leonardoagarcia@gmail.com}} 
    \end{center}
}
\parbox{0.30\textwidth}{
    \begin{center}
    ...
    \LHead{Orientador} \\
    \LHead{Universidade Federal de Itajubá} \\
    \LHead{\texttt{tfmatias@gmail.com}} 
    \end{center}
}
\end{center}
\end{textblock}
