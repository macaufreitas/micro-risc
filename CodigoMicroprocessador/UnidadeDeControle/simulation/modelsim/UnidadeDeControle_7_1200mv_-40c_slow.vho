...
-- Equation(s):
-- \Estado~13_combout\ = (opcodeFetch(6) & (\Estado.OpRegImed16~q\ & (opcodeFetch(7) & !opcodeFetch(4))))
...
-- Equation(s):
-- \Estado~16_combout\ = (!opcodeFetch(3) & (!opcodeFetch(5) & \Estado~13_combout\))
...
-- Equation(s):
-- \Estado~14_combout\ = (opcodeFetch(3) & (opcodeFetch(5) & \Estado~13_combout\))
...
-- Equation(s):
-- \Estado~15_combout\ = (!\Estado.Busca~q\ & \sitFila~input_o\)
...
-- Equation(s):
-- \Estado~12_combout\ = (\Estado.Fetch~q\ & (\Mux0~0_combout\ & \Mux0~1_combout\))
...
-- Equation(s):
-- \Selector10~1_combout\ = (\Selector10~0_combout\) # ((\Estado.Fetch~q\ & ((!\Mux0~0_combout\) # (!\Mux0~1_combout\))))
