...
-- leFila	=>  Location: PIN_D12,	 I/O Standard: 2.5 V,	 Current Strength: Default
-- habULA	=>  Location: PIN_D14,	 I/O Standard: 2.5 V,	 Current Strength: Default
-- ctrlULA[0]	=>  Location: PIN_B7,	 I/O Standard: 2.5 V,	 Current Strength: Default
-- ctrlULA[1]	=>  Location: PIN_B14,	 I/O Standard: 2.5 V,	 Current Strength: Default
-- ctrlULA[2]	=>  Location: PIN_G16,	 I/O Standard: 2.5 V,	 Current Strength: Default
-- regDataLe	=>  Location: PIN_D11,	 I/O Standard: 2.5 V,	 Current Strength: Default
-- habRegData	=>  Location: PIN_C14,	 I/O Standard: 2.5 V,	 Current Strength: Default
-- ctrlRegData[0]	=>  Location: PIN_C16,	 I/O Standard: 2.5 V,	 Current Strength: Default
-- ctrlRegData[1]	=>  Location: PIN_G15,	 I/O Standard: 2.5 V,	 Current Strength: Default
-- ctrlRegData[2]	=>  Location: PIN_J14,	 I/O Standard: 2.5 V,	 Current Strength: Default
-- ctrlDemuxData	=>  Location: PIN_F13,	 I/O Standard: 2.5 V,	 Current Strength: Default
...
-- opcode[0]	=>  Location: PIN_H16,	 I/O Standard: 2.5 V,	 Current Strength: Default
-- opcode[1]	=>  Location: PIN_F14,	 I/O Standard: 2.5 V,	 Current Strength: Default
-- opcode[2]	=>  Location: PIN_F15,	 I/O Standard: 2.5 V,	 Current Strength: Default
-- opcode[15]	=>  Location: PIN_B13,	 I/O Standard: 2.5 V,	 Current Strength: Default
-- opcode[14]	=>  Location: PIN_K15,	 I/O Standard: 2.5 V,	 Current Strength: Default
-- opcode[13]	=>  Location: PIN_H15,	 I/O Standard: 2.5 V,	 Current Strength: Default
-- opcode[12]	=>  Location: PIN_A13,	 I/O Standard: 2.5 V,	 Current Strength: Default
-- opcode[8]	=>  Location: PIN_J16,	 I/O Standard: 2.5 V,	 Current Strength: Default
-- opcode[11]	=>  Location: PIN_D15,	 I/O Standard: 2.5 V,	 Current Strength: Default
-- opcode[10]	=>  Location: PIN_D16,	 I/O Standard: 2.5 V,	 Current Strength: Default
-- opcode[9]	=>  Location: PIN_A14,	 I/O Standard: 2.5 V,	 Current Strength: Default
-- opcode[7]	=>  Location: PIN_J15,	 I/O Standard: 2.5 V,	 Current Strength: Default
-- opcode[6]	=>  Location: PIN_J13,	 I/O Standard: 2.5 V,	 Current Strength: Default
-- opcode[4]	=>  Location: PIN_C15,	 I/O Standard: 2.5 V,	 Current Strength: Default
...
SIGNAL \opcodeFetch[4]~feeder_combout\ : std_logic;
...
\opcodeFetch[4]~feeder\ : cycloneiii_lcell_comb
-- Equation(s):
-- \opcodeFetch[4]~feeder_combout\ = \opcode[4]~input_o\
...
PORT MAP (
	...
	combout => \opcodeFetch[4]~feeder_combout\);
...
PORT MAP (
	clk => \clock~inputclkctrl_outclk\,
	d => \opcodeFetch[4]~feeder_combout\,
	ena => \opcodeFetch[15]~0_combout\,
	devclrn => ww_devclrn,
	devpor => ww_devpor,
	q => opcodeFetch(4));
...
-- Equation(s):
-- \Selector11~0_combout\ = (opcodeFetch(6) & (\Estado.OpRegImed16~q\ & (opcodeFetch(7) & !opcodeFetch(4))))
...
-- Equation(s):
-- \Selector11~1_combout\ = (!opcodeFetch(3) & (!opcodeFetch(5) & \Selector11~0_combout\))
...
-- Equation(s):
-- \Selector12~0_combout\ = (opcodeFetch(3) & (opcodeFetch(5) & \Selector11~0_combout\))
...
-- Equation(s):
-- \Estado~12_combout\ = (!\Estado.Busca~q\ & \sitFila~input_o\)
...
-- Equation(s):
-- \Mux0~0_combout\ = (!opcodeFetch(13) & (opcodeFetch(15) & (!opcodeFetch(14) & !opcodeFetch(12))))
...
-- pragma translate_on
PORT MAP (
	dataa => opcodeFetch(13),
	datab => opcodeFetch(15),
	datac => opcodeFetch(14),
	datad => opcodeFetch(12),
...
-- Equation(s):
-- \Selector10~0_combout\ = (\Estado.Fetch~q\ & (\Mux0~0_combout\ & \Mux0~1_combout\))
...
-- Equation(s):
-- \Selector0~0_combout\ = (\leFila~reg0_q\ & ((\Estado.Sub_regImed_16~q\) # ((\Estado.ResultRegImed~q\) # (\Estado.FimInstrucao~q\))))
...
-- Equation(s):
-- \Selector2~0_combout\ = (\Estado.Add_regImed_16~q\) # (((\Estado.ResultRegImed~q\) # (\Estado.Fetch~q\)) # (!\Estado.Busca~q\))
...
-- Equation(s):
-- \Selector2~1_combout\ = (\Estado.OpRegImed16~q\) # ((\Estado.Sub_regImed_16~q\) # ((\habULA~reg0_q\ & \Selector2~0_combout\)))
...
-- Equation(s):
-- \Selector3~0_combout\ = (\Estado.Sub_regImed_16~q\) # ((\ctrlULA[2]~reg0_q\ & \WideOr4~combout\))
...
-- Equation(s):
-- \Selector4~2_combout\ = (\Estado.Add_regImed_16~q\) # ((\Estado.Sub_regImed_16~q\) # ((\habRegData~reg0_q\ & \WideOr4~combout\)))
...
-- Equation(s):
-- \Selector8~0_combout\ = (\habRegData~0_combout\ & ((opcodeFetch(0)) # ((\ctrlRegData[0]~reg0_q\ & \WideOr4~combout\)))) # (!\habRegData~0_combout\ & (((\ctrlRegData[0]~reg0_q\ & \WideOr4~combout\))))
...
-- Equation(s):
-- \Selector7~0_combout\ = (\habRegData~0_combout\ & ((opcodeFetch(1)) # ((\ctrlRegData[1]~reg0_q\ & \WideOr4~combout\)))) # (!\habRegData~0_combout\ & (((\ctrlRegData[1]~reg0_q\ & \WideOr4~combout\))))
...
-- Equation(s):
-- \Selector6~0_combout\ = (\habRegData~0_combout\ & ((opcodeFetch(2)) # ((\ctrlRegData[2]~reg0_q\ & \WideOr4~combout\)))) # (!\habRegData~0_combout\ & (((\ctrlRegData[2]~reg0_q\ & \WideOr4~combout\))))
...
-- Equation(s):
-- \Selector13~0_combout\ = (\Estado.Erro~q\) # ((\Estado.OpRegImed16~q\ & ((!\Mux4~0_combout\) # (!opcodeFetch(7)))))
...
-- Equation(s):
-- \Selector13~1_combout\ = (\Selector13~0_combout\) # ((\Estado.Fetch~q\ & ((!\Mux0~0_combout\) # (!\Mux0~1_combout\))))
